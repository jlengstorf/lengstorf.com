...
# syncs files with 30-day cache expiration + removes unused files
aws s3 sync ./public s3://lengstorf.com --cache-control "max-age=2592000" --exclude "*" --include "*.html" --include "*.pdf" --include "*.xml"  --include "*.js" --include "*.css" --include "*.png" --include "*.svg" --include "*.ico" --include "*.jpg" --include "*.json" --include "*.txt" --include "*.gif" --delete
