...
<figure class="figure figure--center">
  <img src="./images/pizza-thrower.jpg" alt="Teenage Mutant Ninja Turtles Pizza Thrower." />
  <figcaption class="figure__caption">
    The epitome of combat effectiveness and practicality.
    <small class="figure__attribution">
      Credit: 
      <a class="figure__attribution-link" 
         href="https://playmatestoys.com/brands/teenage-mutant-ninja-turtles/">
        Playmates
      </a>
    </small>
  </figcaption>
...
<figure class="figure figure--right">
  <img src="./images/ninja-rap.gif" alt="Vanilla Ice — Ninja Rap." />
  <figcaption class="figure__caption">
    Go ninja! Go ninja! Go!
    <small class="figure__attribution">
      Credit: 
      <a class="figure__attribution-link" 
         href="http://amzn.to/1O1Ldwi">
...
<figure class="figure figure--center">
  <img src="./images/its-in.gif" alt="Oh my god, it's in!" />
  <figcaption class="figure__caption">
    <small class="figure__attribution">
      Credit: 
      <a class="figure__attribution-link" 
         href="http://amzn.to/1LLT6IK">
        Superbad
      </a>
    </small>
  </figcaption>
...
<figure class="figure figure--center">
  <img src="./images/sriracha.jpg" alt="Sriracha sauce." />
  <figcaption class="figure__caption">
    <small class="figure__attribution">
      Credit: 
      <a class="figure__attribution-link" 
         href="http://www.huyfong.com/">
        Huy Fong Foods
      </a>
    </small>
  </figcaption>
