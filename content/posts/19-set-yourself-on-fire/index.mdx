...
description: >
  When asked if you can do something you don't know how to do, you can say no,
  or you can set yourself on fire, say yes, and then figure it out.
...
sink-or-swim moment: **you'll either find a way to put this fire out, or you're
toast.**
...
[^musician]: I use the term "musician" loosely, here.
...
[^wayback]:
  This isn't actually the _very_ first site. The Wayback Machine doesn't have a
  copy of it, unfortunately.
...
[3]:
  https://web.archive.org/web/20070910075625/http://www.thenategreenexperience.com/
