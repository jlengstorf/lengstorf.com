...
description: >
  Planning may not be a sexy topic, but learning to plan properly means higher
  productivity, less stress, and more free time — and THAT is pretty damn sexy.
...
**Hope — for all the good it brings — is a terrible thing to rely on when you
...
**If the project isn't explicitly laid out, it's easy to spin your wheels or
procrastinate.**
...
**If you do a bunch of work under incorrect assumptions, you'll end up doing
...
The same holds true for self-directed projects: **if I have to stop working to
think about the strategy, I'm context switching and adding unnecessary mental
fatigue.**
...
**Write down _everything_ required before the project is considered complete,
and make sure the whole team has reviewed and approved it.**
...
**Laying out a solid plan is vital for a project to be completed on schedule, on
budget, and without unnecessary stress.**
...
Most importantly, **you'll gain all the benefits that come from completing
projects** on time, on budget, and without huge hassles or setbacks.
...
[^cheesesticks]:
  Hey! Cheese sticks weren't on the original work order! But now that we've
  thoroughly considered the goals of the project, cheese sticks were always
  necessary.

[^personalprojects]:
  If you're working on a personal project, you may think, "I don't need to
  define the scope — I can figure it out as I go." You're not wrong, but you're
  probably about to make your life a lot harder than you need to. I'm speaking
  from experience, here.

[^scopecreep]:
  This is especially important if you're working with paying clients. The scope
  is what keeps the price where it is — if the scope changes, the price changes.
  Without clearly defined, measurable scopes, you're almost guaranteed to run
  into [scope creep][5], and that either means you're working for free or your
  client is paying money they didn't expect to pay — in either scenario there's
  unnecessary tension and resentment.
