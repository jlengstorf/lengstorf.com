---
date: 2016-01-11T07:59:00-08:00
author: jason
draft: true
...
- The Problem with Labels
    + Labels Come with Rules
    + Labels Come with Stereotypes
    + Labels Come with a Bunch of Strangers Who Can Fuck Up Your Reputation
    + Labels Encourage Groupthink
- Why I'm Working Toward a Label-Free Bio
    + It eliminates some of my automatic behavior
    + It forces me to own every decision I make
    + It prevents me from choosing friends by default
- But Isn't "Anti-Label" a Label?
    + The goal is to remove internal reliance on external definition
    + Other people will always apply labels to you; you shouldn't apply labels to yourself

---
When I wrote my [retrospective on last year's travel]({{< ref "blog/2015-12-30_year-in-review.md" >}}), I included a section about my distaste for the label "digital nomad":
...
You need to sell all your stuff and travel the world. You need to put certain "DN Hubs" on your route. You need to choose which faction you belong to: the Web Folks, the Drop-Shippers, or the Writers.[^factions]

[^factions]:
    This in itself is a rule that bothers me: there is no real limit to what you can do remotely for work. If your job is based on the computer and/or conversation, you can do it from anywhere.

And while none of these rules are real — mostly they're the opinions of early-adopting writers who get cited by newcomers until the ideas become canon — they all create barriers and pressure.

If you watch the [Digtal Nomad subreddit](https://www.reddit.com/r/digitalnomad/), there are typically multiple posts daily where someone wants to "get in on this whole DN thing." The posts usually feature questions about whether or not they'd _truly_ be digital nomads.

But to ask whether you're _truly_ a digital nomad is similar to asking if you're _truly_ a vegan: it depends who you ask.[^veggies]
...
### \#2: Labels come with stereotypes

Picture an Herbalife salesperson. A "legalize marijuana" activist. A yoga fanatic. A CrossFitter.

Each of those labels carries stereotypes: Herbalife salespeople are get-rich-quick suckers who get pulled into multi-level marketing schemes; legal weed proponents are unwashed hippie burnouts (or aspiring burnouts); yoga fanatics spout starchild bullshit like, "Feel the universe engulf you like a warm ocean of love, and let positivity tingle on your skin like a thousand tiny kisses"; CrossFitters eat Paleo, work out so hard they puke, and judge the holy Christ out of you for not going to CrossFit.
...
### \#3: Labels come with a bunch of strangers who can fuck up your reputation
...
Now, a good portion of the world looks at _all_ Catholic priests with suspicion, like, "I don't know about priests... I heard his kind are all kidfuckers."

Similarly, startup dudes everywhere are expected to be socially struggling, hoodie rocking, micro-aggression lobbing twenty- and thirty-something white males. The world sees _Silicon Valley_ and Mark Zuckerberg and that stereotype sinks in.

Sometimes these strangers are the figureheads at the epicenter of the label, like in the case of Donald Trump giving renewed life to a caricature of Republicans as bigoted, out of touch, and stupid.
...
[^games]:
    The closest I get is Angry Birds when I have a few minutes to kill.

In the spirit of this article, I'm choosing not to research what _actually_ happened; I want to share the stereotypes that leaked out to me — the non-gamer — that are now attached to gamers. That, and I don't have a wifi connection right now and can't be bothered to look it up on my phone.

Here's how I understood Gamergate:

1. There was a concern raised that women were represented in sexist ways in most video games: scantily-clad, dependent on male heroes, etc.
2. Game studios started to include more diversity in games' heroes.
3. Male gamers did not like this, and got _real_ upset about the "oppression" they faced.
...
It's hard to imagine that many of the (who I assume to be) teenaged boys who stalked and threatened people as part of Gamergate would ever do anything like that on their own.

However, because they're "gamers", the group felt threatened by change, and — galvanized by their label — they started kicking ideas around in an echo chamber. Since there wasn't much by way of dissenting opinion, the ideas were able to amplify and mutate, changing from a probably-innocuous initial idea ("I disagree with Felicia Day") to something horrifying ("We should kill Felicia Day").

Labels create closed communities, and those communities become breeding grounds for extremism.

Even on an inherently open platform like social media, people are able to create walled gardens of just the people who match their labels, and as a result we see misinformation and hate somehow spreading _faster_, despite the fact that there's more access to facts than ever before.
...
It's the external comfort of the label that allows us to overcome the cognitive dissonance of doing something awful:

"I would _never_ remove my neighbor from his home and drop him in a labor camp. But I'm an _American_, and _Americans_ need to beat the threat of the Japanese ... so fuck the Tanaka family."

"I believe everyone deserves the right to be free, but Muslims [label] are threatening Americans [label], and I'm an American, so if I have to choose I choose America."

That's now how reality works, but when we dumb down reality using labels, the logic seems obvious and straightforward.

## Why I'm Working Toward a Label-Free Bio

Once I started to see the sneaky evil of slapping labels on myself, I made a decision: I would do my best to avoid lumping myself into a group in the future.

An important distinction to draw is that I don't _avoid associating with people_. I'm not advocating that no one ever joins a CrossFit gym or plays a video game. I only avoid _allowing the label to define me_, and — more importantly — allowing the group to make decisions on my behalf.
...
### Anti-label means resisting external definition.

There's no way to stop people from labeling each other. We're hard-wired to stereotype for simplicity — we'd be locked in endless analysis otherwise.

What we _can_ control, however, is whether or not we internalize those labels.

For years, I was told I wasn't a "people person". And, because the evidence was in favor of that label, I internalized it. I believed that I wasn't a people person, and my social interactions were 
