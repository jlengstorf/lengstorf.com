...
If you're anything like me, the default answer might be to say, "Not much. I'm working as a freelancer now, which is pretty exciting. How are you?"
...
I make sure to send a personal note thanking the person for each referral as well, except in the case of my highest-referring clients — they send too many leads, so I'd be spamming them.
...
[^coldcalls]:
    These work. I'm not saying you *shouldn't* make cold calls. I just never liked the idea of becoming a telemarketer for my own services, so I worked around the problem.
...
[^dating]:
    I think of it like dating, because to me it's kind of the same thing. I have *never* had success approaching a stranger and wooing her. However, if I get introduced by a mutual friend, I feel far less awkward and there's a much higher chance that we'll hit it off.<br><br>I think this happens because the introduction creates a reason for me to be there. My friend has vouched for me, and this means the conversation starts on level ground — I don't have to prove I deserve to be there, and the conversation can progress naturally.
