---
date: 2015-10-12T14:51:24-08:00
author: jason
draft: true
...
The trick is making the distinction between realizing our project's requirements are out of our reach[^reasonable] (such as Kidstarter for Robin and I) and coming to grips with the fact our project will require actual work.
...
[^ideas]:
    Take that sweeping generalization with a *huge* grain of salt, but also keep in mind these ostensibly *terrible* ideas that succeeded: the app Yo is [worth $5–10 million](https://en.wikipedia.org/wiki/Yo_(app)); someone put filtered water in a bottle and charged a 4,000% markup; oh, and remember the [pet rock](https://en.wikipedia.org/wiki/Pet_Rock)?
...
With decreased focus and increased frustration, the arrival of a new idea looks *extra* sexy, and it's very difficult not to drop our boring, decidedly *un*sexy current project to pursue this newer, shinier opportunity.

### Worse, The Slog happens in a vacuum.

Easily the worst part of The Slog is the utter absence of outside feedback.

The project's not ready yet, so you don't have something to show. So you're stuck in that awkward space where only you *really* understand what the project will ultimately become, and so much is lost by explaining the project to someone else[^explaining] that it's ultimately more frustrating to share it than to keep it to yourself until you've made more progress.
...
Planning a project is decidedly not exciting. So when we're riding high the ecstatic waves of Total Infatuation, the *last* think we'll want to do is slow down and start tearing the idea into well-planned pieces.

But we have to.

**A project without a plan still requires planning. It just takes longer to redo work that's planned *after* it's already been done wrong.**
...
For many ideas, we forget to write the ending. We end up with The Underpants Gnome Problem, where we have a great idea, but no clue what happens between A) building our project and C) taking a McDuckian swim in our cash-filled vault.

Every project needs a defined set of goals. That can be very concrete, as in, "I will run the Boston Marathon without walking," or very abstract, such as, "I will be 1% better today than I was yesterday."

As long as it's something we feel confident measuring — and confident achieving[^reasonable] — it gives us a target to shoot for and a clearly defined finish line.

[^reasonable]:
    Setting a goal that's too ambitious — for example, a brand new freelancer with no network to speak of setting a goal to make $10,000 per month within six months — is probably setting you up to fail. With a goal like that, getting to $8,000 per month (a huge accomplishment) would be a "failure". That makes what should have been a cause for celebration into something demotivating.<br><br>Another way to approach an ambitious goal like that is to aim to grow revenue by 5% month over month, or to have a six-month operating fund set aside in cash. Both create a similar outcome — financial stability — without the extreme specificity that makes even a good outcome seem like a failure.
...
The startup motto to combat this problem is, "Ship early. Ship often."
